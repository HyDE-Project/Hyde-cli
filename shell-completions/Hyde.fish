function _Hyde
    ...
    set descriptions[39] "   Pipes stdouts to less"
    set descriptions[40] "   Diff preserved dotfiles"
    set descriptions[41] " [*] Hyde Config File & Directory status"
    set descriptions[42] " Reloads waybar"
    set descriptions[43] " Reset changes"
    set descriptions[44] " Default animations"
    set descriptions[45] " Hyde-cli version"
    set descriptions[46] " Theme selector"
    set descriptions[47] " Disable blur"
    set descriptions[48] " Executables"
    set descriptions[49] " Select sddm theme"
    set descriptions[50] " Clear some storage by deleting old backups"
    set descriptions[51] " [*]Set waybar size"
    set descriptions[52] "  Add custom file"
    set descriptions[53] "  Drag to manually snip an area"
    set descriptions[54] " Reload wallpaper cache"
    set descriptions[55] " Restores dots from a clone repository "
    set descriptions[56] " Information about Hyde and its components"
    ...
    set descriptions[86] " Disable tranparency"
    set descriptions[87] "  Reinitialize screencap"
    set descriptions[88] " Links a clone directory. Useful if you want to change your CloneDir"
    set descriptions[89] " Inhibits idle when player status: 'Playing"
    set descriptions[90] "  Print all outputs"
    set descriptions[91] " Next theme"
    set descriptions[92] "  Display this help message"
    set descriptions[93] " Wallpaper selector"
    ...
    set literal_transitions[1] "set inputs 28 56 32 45 4 31 20 78 95 79 48 81 38 80 83 71 12 25 61 64 29 65 75; set tos 24 3 4 5 6 25 8 9 10 11 12 15 13 14 16 17 18 19 20 21 23 2 7"
    set literal_transitions[2] "set inputs 30 37 7 43 8; set tos 26 26 33 26 35"
    set literal_transitions[3] "set inputs 105 41; set tos 26 36"
    set literal_transitions[6] "set inputs 27 85; set tos 26 31"
    set literal_transitions[7] "set inputs 88 16 13 55; set tos 26 26 26 26"
    set literal_transitions[8] "set inputs 46 91 103 82 102; set tos 26 26 26 26 26"
    set literal_transitions[9] "set inputs 49; set tos 26"
    set literal_transitions[11] "set inputs 68 54; set tos 26 26"
    set literal_transitions[12] "set inputs 89 73 98; set tos 26 26 30"
    set literal_transitions[13] "set inputs 104; set tos 26"
    set literal_transitions[14] "set inputs 97; set tos 26"
    set literal_transitions[15] "set inputs 77 69 34 67 23; set tos 26 26 26 27 28"
    set literal_transitions[18] "set inputs 14 33 50 2; set tos 26 26 26 26"
    set literal_transitions[20] "set inputs 93 94 66 59; set tos 26 26 26 26"
    set literal_transitions[21] "set inputs 72 96 84; set tos 26 26 29"
    set literal_transitions[24] "set inputs 42 51 106; set tos 26 34 26"
    set literal_transitions[27] "set inputs 6 92 15 63 76 52; set tos 26 26 26 26 26 26"
    set literal_transitions[28] "set inputs 36 17 70; set tos 26 26 26"
    set literal_transitions[29] "set inputs 1 101 3; set tos 26 26 26"
    set literal_transitions[30] "set inputs 10 99 19 35 21 87 53 90 18; set tos 26 26 26 26 26 26 26 26 26"
    set literal_transitions[31] "set inputs 22 24 100 9; set tos 26 26 26 26"
    set literal_transitions[32] "set inputs 57; set tos 26"
    set literal_transitions[33] "set inputs 11 47 60 86; set tos 26 26 26 26"
    set literal_transitions[34] "set inputs 26; set tos 26"
    set literal_transitions[35] "set inputs 5 44 62 74; set tos 26 26 26 26"
    set literal_transitions[36] "set inputs 39 40 58; set tos 26 26 26"
